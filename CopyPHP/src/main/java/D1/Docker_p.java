...
public class Docker_p {
	...
	driver.findElement(By.xpath("//*[@id='wish6']/div[3]/a")).click();
	 Set<String> windows=driver.getWindowHandles();
	 System.out.println(windows.size());
		Iterator<String> it=windows.iterator();
		it.next();
	...
	String h= driver.findElement(By.xpath("//*[@id='body-section']/div[2]/div/div/div[2]/div/span[1]/strong")).getText();
	...
	public void tearDown() throws Exception {
		...
		Thread.sleep(1000);
		String s= driver.findElement(By.xpath("//*[@id='loginfrm']/div[1]/div[1]")).getText();
